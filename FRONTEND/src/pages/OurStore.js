                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <div className="product-tags d-flex flex-wrap align-items-center gap-10">
                                        <span className="badge bg-light rounded-3 py-2 px-3 text-secondary">Headphone</span>
                                        <span className="badge bg-light rounded-3 py-2 px-3 text-secondary">Laptop</span>
                                        <span className="badge bg-light rounded-3 py-2 px-3 text-secondary">Mobile</span>
                                        <span className="badge bg-light rounded-3 py-2 px-3 text-secondary">Tablet</span>
                                        <span className="badge bg-light rounded-3 py-2 px-3 text-secondary">Wire</span>
                                    </div>
                                </div>
                            </div>
                            <div className='filter-card mb-3'>
