                            ...
                            <div className='border-bottom py-4'>
                                ...
                                <div className='w-75 d-flex gap-10'>
                                    <div className='w-25 position-relative'>
                                        <span className="badge bg-secondary text-white rounded-circle p-2 positio-absolute" style={{"top" : "-10px", "right" : "2px"}}>1</span>
                                        <img className='img-fluid' src={watch} alt="" /></div>
                                    <div>
                                        <h5 className="total-price">
                                            afasf
                                        </h5>
                                        <p className='total-price'>dasds</p>
                                    </div>
                                </div>
                                <div className='flex-grow-1'>
