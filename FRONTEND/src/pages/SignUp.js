            ...
            <div className="col-12">
                <div className="auth-card">
                    ...
                    <form action="" onSubmit={formik.handleSubmit} className='d-flex flex-column gap-15'>
                        ...
                        <CustomInput type="password" name="password" placeholder='Password' classname='mt-1' value={formik.values.password} onChange={formik.handleChange("password")} onBlur={formik.handleBlur("password")}/>
                        <div className="error" style={{ color: 'red' }}>
                            {
