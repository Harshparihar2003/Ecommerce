            ...
            <div className="container-xxl">
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex py-3 justify-content-between align-items-center mb-2 cart-data">
                           ...
                           <div className='cart-col-3 d-flex align-items-center gap-15'>
                            <div><input className='form-control' type="number" min={1} max={10} name="" id="" /></div>
                            <div>
